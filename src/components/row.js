...
const Row = () => {
    ...
    return (
            ...
            <div className='border border-warning border-4' >
               <h2>clothes</h2>
            ...
            <div className='overflow-auto d-flex justify-content-between' >
                {arr2.map((ele)=>(<Cards id = {ele.id} price={ele.price} img={ele.img}  company={ele.company}  qty={ele.qty} />))}

            </div>
            <h2> (Electronic & Phone)</h2>
            <div className='overflow-auto d-flex justify-content-between' >
                {arr3.map((ele)=>(  <Cards id = {ele.id} price={ele.price}  img={ele.img}  company={ele.company} qty={ele.qty}  />)  )}
            </div>
